...
# для склонения коров/быков
morph = pymorphy2.MorphAnalyzer()

# кэш уже загаданных чисел
cash = []


# определяет, явялется ли цифра быком
...
print("Компьютер загадал число. Отгадайте же его:")
